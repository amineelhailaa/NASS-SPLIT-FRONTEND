...
const faqs = [
  {
    question: 'Is Nass Split free?',
    answer:
      'Yes, Nass Split is free to use for core splitting and group management. We offer a premium tier for automated bank syncing and detailed financial reporting, but the essential features will always remain free for everyone.',
    tags: [],
  },
  {
    question: 'How do I invite roommates?',
    answer:
      "Tap the 'Groups' tab, select your household, and hit 'Invite Members'. You can share a unique invite link or scan a QR code to get everyone on board instantly.",
    tags: ['Easy Setup', 'Unlimited Members'],
  },
  {
    question: 'Is my data secure?',
    answer:
      'Absolutely. We use 256-bit AES encryption and never store your sensitive bank credentials. Your financial privacy is our top priority.',
    tags: [],
  },
  {
    question: 'How do I settle up?',
    answer:
      "When you're ready to clear balances, Nass Split calculates the 'Optimal Path'—minimizing the total number of transfers. You can record a payment as cash or link your preferred payment app to settle instantly.",
    tags: ['Optimized Debt Reduction'],
  },
]
...
<template>
  ...
  >
    ...
    <section class="relative px-16 pt-40 pb-20 overflow-hidden">
      ...
      <div class="flex flex-col gap-6">
        <div class="inline-flex w-fit items-center gap-2 rounded-full bg-cerulean-500/10 px-5 py-1.5">
          ...
          <span class="text-cerulean-500 font-bold text-sm tracking-wide">Support Center</span>
        </div>
        <h1 class="text-6xl md:text-7xl font-extrabold tracking-tight leading-none">
          Frequently Asked<br />
          <span class="text-cerulean-700">Questions</span>
        </h1>
        <p class="text-xl text-cerulean-800/60 leading-relaxed max-w-2xl">
          Everything you need to know about managing shared expenses effortlessly with Nass Split.
        </p>
      </div>
    </section>
      ...
      <div class="flex flex-col gap-4">
        ...
        >
          ...
          <button
            ...
            @click="toggle(index)"
          >
            <span class="text-lg font-bold text-cerulean-800">{{ faq.question }}</span>
            <span
          ...
          >
            <p class="text-cerulean-800/70 leading-relaxed text-base">{{ faq.answer }}</p>
            <div v-if="faq.tags.length" class="flex flex-wrap gap-2">
              <span
      ...
      >
        <div class="flex flex-col gap-4">
          <div class="flex items-center gap-3">
            ...
            <h2 class="text-3xl font-bold text-white">Still have questions?</h2>
          </div>
          <p class="text-white/80 text-lg">Our support team typically responds in under 2 hours.</p>
        </div>
        <button
    ...
    <!-- CTA Banner -->
    <section
      class="mb-24 px-10 py-20 text-center relative overflow-hidden bg-cerulean-800"
    >
      <div class="relative z-10 flex flex-col gap-8 items-center">
        <h2 class="text-4xl md:text-5xl font-extrabold text-white tracking-tight">
          Join over 50,000 roommates managing<br class="hidden md:block" /> expenses without the stress.
        </h2>
        <button
